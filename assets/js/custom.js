...
//        });
        ...
        if (full_name.length > 0) {
            if (validateEmail(email) === true) {
                $.ajax({
                    url: "http://print-decor.eu/rateit/index.php/Users/verifyregister", //server side script checkout
                    data: {
                        username: username,
                        password: password,
                        email: email,
                    ...
                    success: function (data) {
                        ...
                        if (data == 0) {
                            ...
                            setTimeout(function () {
                                window.location.href = "http://print-decor.eu/rateit/index.php/Users/login";
                            }, 1500);
